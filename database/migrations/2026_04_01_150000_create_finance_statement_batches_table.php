...
return new class extends Migration
{
    ...
    {
        Schema::create('finance_statement_batches', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->enum('statement_type', ['BALANCE_SHEET', 'PROFIT_LOSS']);
    ...
    {
        Schema::dropIfExists('finance_statement_batches');
    }
};
