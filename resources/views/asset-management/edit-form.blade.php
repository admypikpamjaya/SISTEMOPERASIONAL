                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="purchase_year" class="form-control" id="purchase_year" min="2000" max="{{ date('Y') }}" value="{{ $asset->purchaseYear }}" placeholder="Masukkan tahun pembelian">
                                </div>
                            </div>
                        </div>
                    </div>
