...
@section('title', __('app.blast.edit_template_title'))
...
<div class="tplf-page">
    <div class="tplf-head">
        <div>
            <div class="tplf-title">{{ __('app.blast.edit_template_title') }}</div>
            <div class="tplf-sub">{{ __('app.blast.edit_template_subtitle') }}</div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.blast.templates.update', ['id' => $template->id]) }}">
                ...
                <div class="tplf-grid">
                    <div>
                        ...
                        <select name="channel" id="channel" class="tplf-select" required>
                            <option value="whatsapp" {{ old('channel', strtolower((string) $template->channel)) === 'whatsapp' ? 'selected' : '' }}>{{ __('app.blast.whatsapp') }}</option>
                            <option value="email" {{ old('channel', strtolower((string) $template->channel)) === 'email' ? 'selected' : '' }}>{{ __('app.blast.email') }}</option>
                        </select>
                    </div>
            ...
            <div class="tplf-footer">
                <button type="submit" class="tplf-btn primary">
                    <i class="fas fa-save"></i> {{ __('app.blast.update_template') }}
                </button>
