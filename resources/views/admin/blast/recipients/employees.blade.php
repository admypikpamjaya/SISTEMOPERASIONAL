...
<div class="emp-page">
    <div class="emp-head">
        <div>
            <div class="emp-head-title">Recipient Koperasi Tirta Jatik Utama</div>
            <div class="emp-head-sub">Sumber data: file <b>recipent data koperasi tirta jatik utama</b>.</div>
        </div>
