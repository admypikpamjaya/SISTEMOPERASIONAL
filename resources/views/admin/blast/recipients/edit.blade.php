@extends('layouts.app')
@section('title', __('app.blast.edit_student_data_title'))
@section('content')
...
<div class="recipient-form-wrapper">
    ...
    <div class="page-header">
        ...
        <div class="header-content">
            <h1>{{ __('app.blast.edit_student_data_title') }}</h1>
            <p>{{ __('app.blast.edit_student_data_subtitle') }}</p>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="form-card">
            <div class="card-header">
                <strong>{{ __('app.blast.edit_recipient_form') }}</strong>
                <div class="subtitle">{{ __('app.blast.edit_recipient_form_subtitle') }}</div>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group {{ $errors->has('wa_wali_2') ? 'has-error' : '' }}">
                            ...
                            <input type="text"
                                   ...
                                   id="wa_wali_2"
                                   placeholder="+62 812 3456 789"
                                   value="{{ old('wa_wali_2', $recipient->wa_wali_2) }}">
                        ...
                        <div class="form-group full {{ $errors->has('catatan') ? 'has-error' : '' }}">
                            ...
                            <textarea name="catatan"
                                      id="catatan"
                                      placeholder="{{ __('app.blast.notes_placeholder') }}">{{ old('catatan', $recipient->catatan) }}</textarea>
