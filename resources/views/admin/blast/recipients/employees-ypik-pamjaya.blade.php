    ...
    <div class="ypk-panel">
        <div class="ypk-panel-body">
            ...
            <div class="ypk-toolbar">
                ...
                <form id="bulk-delete-ypik-pamjaya-form" method="POST" action="{{ route('admin.blast.recipients.employees-ypik.bulk-delete') }}">
                    @csrf
                    @method('DELETE')
                </form>
                            ...
                            <tr>
                                <td>
                                    <input
                                        ...
                                        name="selected_ids[]"
                                        value="{{ $employee->id }}"
                                        form="bulk-delete-ypik-pamjaya-form"
                                    >
                                </td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const deleteBtn = document.getElementById('bulkDeleteYpikPamJayaBtn');
