...
const env = {
  ...
  QUEUE_CONCURRENCY: Math.max(1, parseInteger(process.env.QUEUE_CONCURRENCY, 2)),
  ...
  WA_SEND_TIMEOUT_MS: Math.max(5000, parseInteger(process.env.WA_SEND_TIMEOUT_MS, 45000)),
  WA_ACK_TIMEOUT_MS: Math.max(5000, parseInteger(process.env.WA_ACK_TIMEOUT_MS, 45000)),
  QR_WAIT_TIMEOUT_MS: Math.max(1000, parseInteger(process.env.QR_WAIT_TIMEOUT_MS, 15000)),
